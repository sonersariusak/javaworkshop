...
public interface AllServiceOrder {
	...
	public String OrderAddParameter(long idx,String pName, String orderDate,String orderArrivalDate, double amount, String clob,String blob) throws Exception;
	...
	public List<Jws1Order> searchOrderID(long ID)
	throws Exception;
