...
public class AmountByArrivalDate extends AbstractPage implements Serializable {

	private static final long serialVersionUID = 1L;

	private List<Jws1Order> orderList;
	private double searchTextForAmount = 0;
	private Timestamp searchTextForStartDate;
	private Timestamp searchTextForEndDate;


	public AmountByArrivalDate() throws Exception {
	...
	public void searchAmountByArrivalDate() {
		try {
			...
			orderList = service.getOrderListByAmountByOrderArrivalDate(searchTextForAmount, searchTextForStartDate, searchTextForEndDate);
			System.err.println("Soner: "+ orderList.size());
	...
	public void setSearchTextForStartDate(Timestamp searchTextForDate) {
		this.searchTextForStartDate = searchTextForDate;
	}

	public Timestamp getSearchTextForStartDate() {
		return searchTextForStartDate;
	}

	public void setSearchTextForEndDate(Timestamp searchTextForEndDate) {
		this.searchTextForEndDate = searchTextForEndDate;
	}

	public Timestamp getSearchTextForEndDate() {
